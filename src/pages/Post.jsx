...
/** Strip HTML tags to get plain text for meta description */
...
function Post() {
    ...
    const metaDesc   = truncate(stripHtml(post.content))
    ...
    return (
        <>
            {/* Per-post SEO — title and description come from the actual post data */}
            <SEO
                title={post.title}
                        ...
                        <div className="flex items-start justify-between gap-4 mb-6">
                            ...
                            {isAuthor && (
                                <div className="flex items-center gap-2 flex-shrink-0">
                                    ...
                                    <Button variant="danger" disabled={deleting} onClick={deletePost} className="gap-1.5">
                                        {deleting ? (
